...
import com.mlynarz.ardena.payload.Response.JwtAuthenticationResponse;
import com.mlynarz.ardena.payload.Request.LoginRequest;
import com.mlynarz.ardena.payload.Response.RoleResponse;
import com.mlynarz.ardena.payload.Request.SignUpRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
        ...
        User user = new User(signUpRequest.getName(), signUpRequest.getUsername(),
                signUpRequest.getEmail(), signUpRequest.getPassword(), signUpRequest.getPhoneNumber(), signUpRequest.getBirthDate());
